...
<template>
  <div class="fixed-button-block">
    <div v-if="props.buttons.audit" class="button-container" id="audit" @click="filterAudit = !filterAudit; $emit('createPost')" :style="filter">
      <div class="wrapper">
    ...
    <div v-if="props.buttons.new" class="button-container" id="new">
      <div class="wrapper">
